/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Mon Jan 15 03:29:40 2024.
...
#else
    static const char *NAMES[] = {"libGLESv2.so", "libGL.so.1", "libGL.so"};
	printf("open_gl NAMES libGLESv2.so libGL.so.1 libGL.so \n");
#endif
